    ...
    return (
        <div className="h-screen w-screen grid grid-cols-2">
            <div className={`relative ${background}`}>
                <div className="absolute top-1/2 -translate-y-1/2 mx-20 font-semibold text-4xl text-white">
                    {title}
                </div>
            </div>
...
Begin.defaultProps = {
    background: "bg-gradient-to-t from-indigo-500 via-purple-500 to-pink-500",
