import LOGO from '../../assets/logoemployee.svg';
import './navbar.css'
        ...
        <div className={`navbar-employee`}>
            <div className={`navbody ${padding}`}>
                <div className='navleft'>
                    <button onClick={() => navigate("/agency")} className='duration-150 ease-in-out flex flex-row items-center text-lg font-semibold text-supergray tracking-wider space-x-5'>
                        <img width={25} alt={'logo'} src={LOGO} />
                        <div>Espace Employé</div>
                    </button>
                </div> 
                <div className='navcenter hidden xs:hidden sm:hidden md:block lg:block xl:block 2xl:block 3xl:block 4xl:block'>
                    <div className='flex flex-row space-x-2'>

                        <NavButton title={"Aujourd'hui"} to={"/agency/"} theme={IThemeNavButton.hosting} />
                        <NavButton title={"Locations"} to={"/agency/messages/"} theme={IThemeNavButton.hosting} />
                        <NavButton title={"Utilisateurs"} to={"/agency/reservations/"} theme={IThemeNavButton.hosting} />
                        <NavButton title={"Agences"} to={"/agency/calendar/"} theme={IThemeNavButton.hosting} />
