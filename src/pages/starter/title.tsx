...
function App() {
    ...
    const [title, setTitle] = useState<string>("Logement special")
    ...
    return (
        <PageBuilder title="Starter" show={show}>
            <>
                <StarterBuilder progress={30} btnClick={test} buttonNext={title.length >= 8 ? SBbuttons.allow : SBbuttons.blocked} theme={SBthemes.home} footer={true} title={"Donnez un titre à votre logement"}>
                    <>
                        <div className="flex flex-col justify-start items-center w-full h-full py-20 overflow-scroll">
                            ...
                            <div className="flex flex-col space-y-2">
                                <div className="font-semibold text-supergray text-2xl ">Donnez-lui un titre</div>
                                ...
                                <div className="flex flex-col pt-6">
                                    <textarea onChange={handleChange} className="animation duration-200 p-4 border-none rounded-xl focus:outline-none ring-gray-400 ring-1 focus:ring-2 focus:ring-black focus:outline-transparent w-full font-medium text-3xl  text-supergray h-40" value={title}></textarea>
